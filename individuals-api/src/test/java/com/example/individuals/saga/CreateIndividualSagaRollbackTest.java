...
public class CreateIndividualSagaRollbackTest {
    ...
    @BeforeEach
    void setUp() {
                    //подготовка для тестовых данных
    ...
    void testRollbackWhenKeycloakFails() {
        ...
        //шибка при создании пользователя вkeycloak
        doThrow(new RuntimeException("О шибка Keycloak")).when(keycloakService).createUser(any(IndividualDto.class));
